...
class TableViewCell: UITableViewCell{
    ...
    func setConstraints(){
        ...
        NSLayoutConstraint.activate([
            ...
            titleLabel.leadingAnchor.constraint(equalTo: imageLabel.trailingAnchor, constant: 35),
            descriptionLabel.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: 15),
            descriptionLabel.leadingAnchor.constraint(equalTo: imageLabel.trailingAnchor, constant: 35),
